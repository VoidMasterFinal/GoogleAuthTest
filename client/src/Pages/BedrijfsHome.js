...
import styles from  '../styles/BedrijfsHome.module.css';
...
export default function BedrijfsHome() {
  ...
  const menuButtons = [
    ...
    },
    {
      ...
      name: 'Onderzoeken Opstellen',
      link: '/OnderzoekOpstellen'
    },
    {
  ...
  return (
    <div>
      ...
      <div>
        <h1 id={styles.over_ons}>Bedrijfsportaal</h1>
        <div id={styles.blokken}>
          <div id={styles.blok_1} name="blok_1">
            <p id={styles.text1}>Welkom {bedrijf}!</p>
